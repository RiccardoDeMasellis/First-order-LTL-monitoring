 ...
 */
public abstract class FolAtomicFormula implements FolFormula, AtomicFormula {
	 ...
	 */
	public FolFormula formulaFactory(FormulaType type, FolTerm left, FolTerm right,
