 ...
 */
public abstract class FolUnaryFormula implements FolFormula, language.UnaryFormula {
	...
	public FolFormula formulaFactory(language.FormulaType type, FolFormula nested){
