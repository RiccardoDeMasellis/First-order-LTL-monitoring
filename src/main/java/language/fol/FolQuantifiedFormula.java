...
public abstract class FolQuantifiedFormula implements FolFormula, QuantifiedFormula{
	...
	@Override
	public FolFormula quantifiedFormulaFactory(OperatorType quantifier, language.Formula nestedFormula, Variable qvar){
		FolFormula res;
	...
	public FolFormula formulaFactory(language.FormulaType type, FolFormula nested, FolVariable qvar){
