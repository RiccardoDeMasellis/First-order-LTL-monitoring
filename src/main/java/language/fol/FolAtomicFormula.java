 ...
 */
public abstract class FolAtomicFormula implements FolFormula, language.AtomicFormula {
	 ...
	 */
	public FolFormula formulaFactory(language.FormulaType type, FolTerm left, FolTerm right,
