...
import language.LocalQuantifiedFormula;
...
public interface FoLtlLocalQuantifiedFormula extends FoLtlLocalFormula, LocalQuantifiedFormula {
	 ...
	 */
	@Override
	default FoLtlFormula quantifiedFormulaFactory(OperatorType quantifier, language.Formula nestedFormula, Variable qvar){
		FoLtlFormula res;
