...
/**
 * This class provides an empty implementation of {@link SortDefinitionVisitor},
 ...
 */
public class SortDefinitionBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements SortDefinitionVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
