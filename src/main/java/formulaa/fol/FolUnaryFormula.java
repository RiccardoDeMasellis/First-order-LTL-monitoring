 ...
 */
public abstract class FolUnaryFormula implements FolFormula, formulaa.UnaryFormula {
	...
	public FolFormula formulaFactory(formulaa.FormulaType type, FolFormula nested){
